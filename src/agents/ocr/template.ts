...
Analyze the extracted text to create a clean transaction entry and extract individual line items. Do not respond in markdown. Respond in JSON format only. Do not add feedback or commentary.
